...
ActiveRecord::Schema.define(version: 2020_10_23_023348) do
  ...
  create_table "deliveries", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchaser_id"], name: "index_deliveries_on_purchaser_id"
  end
  ...
  add_foreign_key "deliveries", "purchasers"
